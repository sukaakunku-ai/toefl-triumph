...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    "whyChooseUs.feature1.title": "Simulasi Realistis ETS",
    "whyChooseUs.feature1.desc": "Rasakan ujian TOEFL asli dengan timer, format soal, dan tingkat kesulitan standar ETS, gratis selamanya!",
    "whyChooseUs.feature2.title": "Penjelasan Detail & Ahli",
    "whyChooseUs.feature2.desc": "Dapatkan jawaban lengkap beserta tips pro yang membuatmu paham seketika – bukan sekadar benar/salah.",
    "whyChooseUs.feature3.title": "Pelacakan Kemajuan Canggih",
    "whyChooseUs.feature3.desc": "Pantau peningkatan skor secara real-time dan identifikasi kelemahanmu untuk hasil optimal.",
  ...
  en: {
    ...
    "whyChooseUs.feature1.title": "Realistic ETS Simulations",
    "whyChooseUs.feature1.desc": "Experience the real TOEFL exam with timers, question formats, and ETS standard difficulty levels, free forever!",
    "whyChooseUs.feature2.title": "Detailed & Expert Explanations",
    "whyChooseUs.feature2.desc": "Get complete answers with pro tips that make you understand instantly – not just right/wrong.",
    "whyChooseUs.feature3.title": "Advanced Progress Tracking",
    "whyChooseUs.feature3.desc": "Monitor score improvements in real-time and identify your weaknesses for optimal results.",
