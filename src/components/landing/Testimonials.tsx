        ...
        return [
            {
                ...
                content: "Wah gila sih, skor TOEFL saya naik 80 poin setelah latihan sebulan di sini. Interface-nya enak banget buat belajar dan gak ngebosenin!",
                rating: 5,
    ...
    return [
        {
            ...
            name: "Rizky Pratama",
            role: "Score Boosted",
            content: "Wow, my TOEFL score jumped 80 points after practicing here for a month. The interface is really nice and not boring at all!",
            rating: 5,
            color: "bg-orange-50 text-orange-600",
        },
        {
            ...
            name: "Anisa Putri",
            role: "Fun Learning",
            content: "I didn't realize I'd been studying for hours because the features are as fun as playing a game. Explanations are easy to understand for beginners.",
            rating: 5,
            color: "bg-blue-50 text-blue-600",
        },
        {
            ...
            content: "The simulation is exactly like the real test. The timing is precise and gets you used to the pressure of the actual exam. Totally worth it!",
            rating: 5,
            color: "bg-purple-50 text-purple-600",
        },
        {
            ...
            content: "I was skeptical at first about a free platform being this good. Turns out it's fully featured from Listening to Structure without any cost.",
            rating: 5,
            color: "bg-red-50 text-red-600",
        },
        {
            ...
            name: "Budi Santoso",
            role: "Fast & Practical",
            content: "Extremely practical for busy workers. Can practice via phone during breaks. No complicated sign-ups, just jump straight in!",
            rating: 5,
            color: "bg-green-50 text-green-600",
        },
        {
            ...
            content: "The question bank is huge and up-to-date. The answer explanations really help in understanding the common patterns in TOEFL exams.",
            rating: 5,
            color: "bg-amber-50 text-amber-600",
        },
    ];
